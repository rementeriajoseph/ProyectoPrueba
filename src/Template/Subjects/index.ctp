    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $subject->subjects_id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $subject->subjects_id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $subject->subjects_id], ['confirm' => __('Are you sure you want to delete # {0}?', $subject->subjects_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
